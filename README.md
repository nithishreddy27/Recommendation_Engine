...
- **Product Recommendation:** Users can input their preferences, such as product department, category, brand, and maximum price range, and the system generates personalized product recommendations based on their preferences.
...
The project utilizes the Flipkart e-commerce dataset, which contains information about various products sold on the Flipkart platform. The dataset includes details such as product name, description, category, brand, price, and discount information.

Dataset link: https://www.kaggle.com/datasets/atharvjairath/flipkart-ecommerce-dataset/data
